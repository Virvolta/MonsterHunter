...
type
    ...
    typeLieu = (quitter,menuPrincipal,creationPersonnage,chambreArrivee,chambre,ville,forge,marchand,cantine,expedition,camp);
...
implementation
uses
    UnitCantine,UnitForge,UnitChasse,UnitMenuPrincipal,unitChambre,unitVille,unitMarchand,unitCampEntrainement;
...
begin
     ...
     case lieuCourant of
          ...
          camp : campHub();                                 //Camp d'entrainement
     end;
end;
